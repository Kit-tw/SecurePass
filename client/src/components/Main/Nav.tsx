...
export default function NavComponents(){
    return(
        ...
        <label htmlFor="" className="text-mono text-lg text-black font-bold hover:cursor-pointer hover:text-accent hover:scale-[1.1]  transform transition duration-250">Password Generation</label>
        <label htmlFor="" className="text-mono text-lg text-black font-bold hover:cursor-pointer hover:text-accent hover:scale-[1.1]  transform transition duration-250">Breach Detection</label>
